...
namespace Astra::CPU::Lib::X16 {
    ...
    LARGE CoreBanking::Fetch(DataFormat fmt, size_t address) {
        ...
        address--;
        auto tmpAddr = address + (m_address << 8);
        if (tmpAddr >= 0xFFFA) {
            switch (tmpAddr & 0xFF) {
                case 0xFA: return 0x03b7;
                case 0xFB: return 0x03;
                case 0xFC: return 0xe8e4;
                case 0xFD: return 0xe8;
                case 0xFE: return 0x038b;
                case 0xFF: return 0x03;
                default:
                    break;
            }
        }
    ...
    int CoreBanking::FetchReadOnly(size_t address) const {
        ...
        if (tmpAddr >= 0xFFFA) {
            switch (tmpAddr & 0xFF) {
                case 0xFA: return 0xb7;
                case 0xFB: return 0x03;
                case 0xFC: return 0xe4;
                case 0xFD: return 0xe8;
                case 0xFE: return 0x8b;
                case 0xFF: return 0x03;
                default:
                    break;
            }
